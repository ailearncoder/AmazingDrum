...
public class WFGuitar2Activity extends Activity implements OnTouchListener
{
	...
	private final String files[] = new String[] { "F", "E", "D", "A", "602",
			"600", "504", "502", "500", "402", "#G", "#F", "#C" };
	private final String path = "/sdcard/王妃/guitar2/";
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.activity_wf_guitar2);
