...
public class PlayDrumActivityBle2 extends Activity {
        ...
        public void run() {
            switch (bleState) {
                ...
                case DEVICE_STATE_LINKFAILED:
                    cancelProgressDialog();
                    MyUtil.showToast(PlayDrumActivityBle2.this, "设备连接失败");
                    break;
                case DEVICE_STATE_SCANFAILED:
                    cancelProgressDialog();
                    MyUtil.showToast(PlayDrumActivityBle2.this, "扫描失败");
                    break;
                case DEVICE_STATE_LINKLOST:
                    cancelProgressDialog();
                    MyUtil.showToast(PlayDrumActivityBle2.this, "设备连接丢失");
                    break;
            }
            isUIRun = false;
        }
