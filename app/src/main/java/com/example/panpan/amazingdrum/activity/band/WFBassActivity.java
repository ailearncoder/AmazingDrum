...
/** 王妃吉他1 */
public class WFBassActivity extends Activity implements OnTouchListener
{
	...
	private final String order3[] = new String[] { "#F", "#F", "500", "502",
			"504", "500", "502" };
	private final String order4[] = new String[] { "402", "402", "402", "402",
			"401", "401", "401", "401" };
	private final String files[] = new String[] { "F", "E", "D", "A", "602",
			"600", "504", "502", "500", "404", "402", "401", "#G", "#F", "C#" };
	private final String path = "/sdcard/王妃/bass/";
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.activity_wf_bass);
	...
	private void initBluetooth()
	{
		...
		if(bleLink.sendData(UartDataDeal.sendCommand(0x01, 0x00, 'G')))
			MyUtil.showToast(this,"已设置乐器为吉他");
		else
		{
			bleLink.dislink();
	...
	private void play(int button)
	{
		...
		switch (button)
		{
			...
			case 3:
				index %= order4.length;
				streamID = soundPool.play(soundIdHashMap.get(order4[index]), 1, 1,
						1, 0, 1);
				index++;
				break;
			case 4:
				streamID = soundPool.play(soundIdHashMap.get("C#"), 1, 1, 1, 0, 1);
				break;
			case 5:
